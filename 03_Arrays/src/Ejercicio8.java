	...
	public static void main(String[] args) {
		...
		do {
			...
			if (opcion == 1) {
				...
				System.out.println("Ha elegido la opción moltiplicar: ");
				resultado = numero1 * numero2;
				System.out.println(resultado);
				listaNumeros.add(resultado);
				listaFrases.add("La moltiplicación de " + numero1 + " y de " + numero2 + " es: " + resultado);
			} else if (opcion == 4) {
				System.out.println("Ha elegido la opción dividir: ");
				resultado = numero1 / numero2;
				System.out.println(resultado);
				listaNumeros.add(resultado);
				listaFrases.add("La división de " + numero1 + " y de " + numero2 + " es: " + resultado);
			} else if (opcion == 0) {
